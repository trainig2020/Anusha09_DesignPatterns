...
import io.anusha.model.ShapeFactory;
import io.anusha.model.ShapeFactory.ShapeType;
...
public class ComputerClient extends JFrame {
	...
	public ComputerClient(int width, int height) {
		this.WIDTH = width;
		this.HEIGHT = height;
	...
	public static void main(String[] args) {
		ComputerClient drawing = new ComputerClient(500, 600);
	}
